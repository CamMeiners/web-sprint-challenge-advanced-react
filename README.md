...
2. When does a componentWillMount function be called? What about a componentWillUpdate?
   WillUpdate is invoked every time there is a re-render, WillMount happens on the first render.
3. Define stateful logic.
   Things that happen when using hooks.
4. What are the three step of creating a successful test? What is done in each phase?
   Arrange: Render what you want to be testing, Act: find what you want to be testing within the previously rendered item, Assert: This is where you define what needs to happen for the test to pass.
